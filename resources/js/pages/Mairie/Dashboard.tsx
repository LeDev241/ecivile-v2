    ...
    <MairieLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          />
          <StatCard icon={CircleCheckBig} title="Validées" value={statusCounts.validees} bgColor="bg-gradient-to-br from-green-500 to-emerald-500" />
          <StatCard icon={CircleSlash2} title="Rejetées" value={statusCounts.rejetees} bgColor="bg-gradient-to-br from-rose-500 to-red-500" />
        </div>
